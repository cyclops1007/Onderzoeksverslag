...
namespace AirBNB.Controllers
{
    public class CalendarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CalendarId,ListingId,Date,Available,Price")] Calendar calendar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CalendarId,ListingId,Date,Available,Price")] Calendar calendar)
        {
